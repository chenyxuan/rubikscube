...
class CubeGroup extends three__WEBPACK_IMPORTED_MODULE_2__.Group {
    ...
    twist(angle, fast) {
        ...
        if (Math.abs(this.angle - angle) < 1e-6) {
            ...
            const duration = _utils__WEBPACK_IMPORTED_MODULE_1__.cube_config.speed * (2 - 2 / (frac + 1));
...
/* harmony export */ });
class Twist {
    constructor(depature, arrival, speed, callback_func) {
...
let Playground = class Playground extends vue__WEBPACK_IMPORTED_MODULE_10__["default"] {
    ...
    idle(value) {
        _cube_twister__WEBPACK_IMPORTED_MODULE_5__.twister.twists.push(new _cube_twister__WEBPACK_IMPORTED_MODULE_5__.Twist(0, Math.PI, _cube_utils__WEBPACK_IMPORTED_MODULE_4__.cube_config.speed * value, (value) => {
