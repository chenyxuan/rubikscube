        ...
        if (this.isPlayerMode && this.isPlaying) {
            ...
            if (this._progress < this.solution.length) {
                if (!_cube_twister__WEBPACK_IMPORTED_MODULE_6__.twister.isTwisting()) {
                    const params = _cube_utils__WEBPACK_IMPORTED_MODULE_5__.stringToTwistParams[this.solution[this._progress]];
