...
let Playground = class Playground extends vue__WEBPACK_IMPORTED_MODULE_6__["default"] {
    ...
    set progress(value) {
        ...
        for (let i = this._progress; i > value; i--) {
            const params = _cube_utils__WEBPACK_IMPORTED_MODULE_5__.stringToTwistParams[this.solution[i - 1]];
