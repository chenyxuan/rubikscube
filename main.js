...
/* harmony import */ var _world__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./world */ "./src/cube/world.ts");
...
class Capturer {
    constructor() {
        ...
        const distance = _utils__WEBPACK_IMPORTED_MODULE_0__.cubelet_defs.size * 3 * this.world.perspective;
        this.world.camera.position.z = distance;
        this.world.camera.near = distance - _utils__WEBPACK_IMPORTED_MODULE_0__.cubelet_defs.size * 3;
        this.world.camera.far = distance + _utils__WEBPACK_IMPORTED_MODULE_0__.cubelet_defs.size * 8;
    }
    generate(state) {
