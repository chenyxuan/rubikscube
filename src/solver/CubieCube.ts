...
export default class CubieCube {
  ...
  /**
   * Class Index To Representant Arrays
   */
  ...
  /**
   * Notice that Edge Perm Coordnate and Corner Perm Coordnate are the same symmetry structure.在对称坐标中棱块和角块是一样的
  ...
  static CornMult(a: CubieCube, b: CubieCube, prod: CubieCube): void {
    for (let corn = 0; corn < 8; corn++) {
      const oriA = a.ca[b.ca[corn] & 7] >> 3;//&按位取与
